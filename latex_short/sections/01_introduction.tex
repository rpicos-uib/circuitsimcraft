...
This paper describes CircuitSimCraft~\cite{picos2026circuitsimcraft}, a modification (``mod'') for
the Fabric mod loader, released as free and open-source software under a Creative Commons
Attribution 4.0 International License (CC~BY~4.0), that adds a complete set of analog circuit
components to Minecraft: resistors, capacitors,
...
The remainder of this paper situates CircuitSimCraft relative to existing simulators and the
