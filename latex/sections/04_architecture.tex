...
CircuitSimCraft is built on Fabric, a lightweight, widely used modding toolchain for
...
crafted by hand from a recipe, or found. CircuitSimCraft adds one further, twentieth block, the
...
(\texttt{/function circuitsimcraft:electrician\_shop}) that clears its own footprint, pours its
